...
class Hero {
  ...
  // Programs from string formatted as '<id> <name>'.
  ...
  // Programs from hero list <li> element.
  ...
  // Programs id and name from the given detail element.
...
describe('Universal', () => {
  ...
  describe('Heroes tests', () => {
    ...
    it(`deletes ${newHeroName} from Heroes list`, async () => {
      ...
      // console.log(await Programs.fromLi(page.allHeroes[0]));
